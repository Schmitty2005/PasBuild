...
In multi-module projects, profiles defined in the aggregator (parent) `project.xml` are automatically inherited by all child modules. This allows you to define shared profiles once at the top level rather than duplicating them in every module.
