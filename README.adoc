...
A Maven-inspired build automation tool for Pascal projects.
...
PasBuild is a command-line build tool for Pascal that brings Maven-like
...
* ✅ Multiple test frameworks (FPCUnit, FPTest, Blaise) with auto-detection
